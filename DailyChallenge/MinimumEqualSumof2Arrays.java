...
public class MinimumEqualSumof2Arrays {
    ...
    public long minSum(int[] nums1, int[] nums2) {
        ...
        long[] minSumZeroCount1 = new long[2];
        calculate(minSumZeroCount1, nums1);

        long[] minSumZeroCount2 = new long[2];
        calculate(minSumZeroCount2, nums2);

        if((minSumZeroCount1[0] > minSumZeroCount2[0] && minSumZeroCount2[1] == 0) ||
                (minSumZeroCount2[0] > minSumZeroCount1[0] && minSumZeroCount1[1] == 0)){
            return -1;
        }
    ...
    // Return {minSumCountWithOnes, ZeroCount}
